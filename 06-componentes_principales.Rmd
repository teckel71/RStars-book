...
![[Arg-Us Korp.]{.smallcaps}](figuras/Arg-Us%20Korp.jpg){width="100%"}
...
```{r video-indicador-argus, echo=FALSE, results='asis'}
insertar_youtube(
  id     = "DpeJxNtELLQ",
  titulo = "Argus Korp sale de compras... pero con información."
)
```

El equipo ha pensado en crear un *ranking* de compañías basándose en estos tres indicadores. Pero, si tienen 3 variables, ¿cómo combinar su análisis para obtener un solo *ranking* de modo objetivo? ¿Cómo ponderar las tres variables?
...
scores2_top10 %>%
  kable_rstars(caption   = "Puntuaciones empresas TMI (Top-10, outliers en cálculo)",
               col.names = c("Empresa",
                             "Puntuación",
                             "I. Diversif.",
                             "I. Fidelizac.",
...
## ![](figuras/star.svg){.hicon} La decisión de *Arg-Us Korp*. {#c06-la-decision-de-arg-us-korp}
