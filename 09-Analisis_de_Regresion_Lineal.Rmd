...
vars_modelo %>%
  kable_rstars(caption = "Variables explicativas del modelo y signo esperado",
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
    ...
    comparativa_ee %>%
      kable_rstars(caption   = "Comparación MCO vs errores robustos HC1",
