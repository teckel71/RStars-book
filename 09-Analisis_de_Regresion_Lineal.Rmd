...
-   **Función `create_patchwork()`**: obtiene, a partir de una lista de gráficos elaborados con `{ggplot2}`, sucesivas composiciones de 4 gráficos (o menos, si es necesario), que devuelve a otra lista:
