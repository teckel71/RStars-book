...
![La distribución Normal...](figuras/01%20Intro.jpg){width="100%"}
...
## ![](figuras/key.svg){.hicon} ¿Qué es R y cómo nos ayuda a analizar datos desde el punto de vista estadístico?
...
## ![](figuras/pie-chart.svg){.hicon} Instalación de R y R-Studio.
...
## ![](figuras/pie-chart.svg){.hicon} R y RStudio. Comienzo: Proyectos.
...
## ![](figuras/pie-chart.svg){.hicon} Scripts.
...
## ![](figuras/pie-chart.svg){.hicon} Funciones.
...
## ![](figuras/pie-chart.svg){.hicon} Paquetes (packages).
...
## ![](figuras/pie-chart.svg){.hicon} Help! (sistema de ayuda).
...
### **Cifras globales del sector en 2210.**

-   **Total de Empresas:** 300

-   **Activos Totales:** 72,421.97 miles de PAVOs
