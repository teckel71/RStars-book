...
De este modo, solo quedará pendiente por activar el paquete "propio" `{MATrstars}`, del que hablaremos más adelante.
...
options(matrstars.figura_num = "5.3", matrstars.tabla_num = "5.2")
muestra_demo <- select(interestelar_100, RENECO)
muestra_demo <- explora_na(
  muestra_demo,
  variables = RENECO,
...
```{r eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
options(matrstars.figura_num = "5.5", matrstars.tabla_num = "5.3")
muestra_demo <- explora_outliers(
  muestra_demo,
  variables = RENECO,
  accion    = "eliminar",
...
```{r eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
options(matrstars.figura_num = "5.13", matrstars.tabla_num = "5.7")
muestra2_demo <- explora_outliers(
  muestra2_demo,
  variables = c(RENECO, ACTIVO, MARGEN, RES),
  accion    = "eliminar",
