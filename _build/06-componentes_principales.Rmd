...
::: {style="text-align: center;"}
**Tabla 6.2.** Resumen de Componentes
:::
...
::: {style="text-align: center;"}
**Tabla 6.3.** Cargas de las componentes obtenidas
:::
...
::: {style="text-align: center;"}
**Tabla 6.4.** Puntuaciones emporesas TMI (Top-10, sin outliers)
:::
...
::: {style="text-align: center;"}
**Tabla 6.5.** Puntuaciones emporesas TMI (Top-10, con outliers)
:::
...
::: {style="text-align: center;"}
**Tabla 6.6.** Puntuaciones emporesas TMI (Top-10, outliers en cálculo)
:::
...
::: {style="text-align: center;"}
**Tabla 6.7.** Puntuaciones emporesas TMI (Top-10, Hubert)
:::
