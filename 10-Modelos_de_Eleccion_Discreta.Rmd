...
### ![](figuras/pie-chart.svg) Detección de valores perdidos.
...
### ![](figuras/pie-chart.svg) Conversión de variables categóricas.
...
## ![](figuras/star.svg){.hicon} Cierre: el veredicto de *Data-Evidence*.
