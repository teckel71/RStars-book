...
comparativa %>%
  kable(caption = "Comparativa de los tres métodos de análisis clúster tratados en el capítulo.",
...
![[Xelia Bluebird, investigadora de la AITM.]{.smallcaps}](figuras/Bluebird.jpg){width="100%"}
...
```{r video-preparando-bluebird, echo=FALSE, results='asis'}
insertar_youtube(
  id     = "I-lKgEEJUUk",
  titulo = "Preparando el Informe Bluebird."
)
```
