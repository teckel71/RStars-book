...
![[Galaxias que
recorrer...]{.smallcaps}](figuras/10%20galaxias.jpg){width="100%"}
...
generar_solucion <- function(modelo) {
  ...
  if (tipo_output == "html") {
    ...
    independencia_coef_tab <- independencia_df %>%
      kable(caption = "Coeficientes del modelo",
            digits  = 3)
  }
...
if (is.null(zeros_report)) {
  ...
  if (tipo_output == "html") {
    ...
    zeros_report %>%
      kable(caption = "Combinaciones con 0 detectadas (antes de imputar)")
  }
}
...
if (!is.null(attr(tab_use, "zeros_imputados"))) {
  ...
  if (tipo_output == "html") {
    ...
    zeros_imputados %>%
      kable(caption = "Combinaciones imputadas (0 → 1) para estimar modelo")
  }
}
```
