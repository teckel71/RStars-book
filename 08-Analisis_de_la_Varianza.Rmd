...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  tablamedias %>%
    kbl(caption = "IRE. Medias por astillero.",
      col.names = c("Astillero", "Observaciones", "IRE medio")) %>%
  kable_styling(full_width = F,
                bootstrap_options = "striped", "bordered", "condensed",
                position = "center",
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
    ...
    tablashapiro <- normalidad %>%
    kbl(caption = "Normalidad (Shapiro-Wilks).",
          col.names = c("Astillero", "p-valor", "Conclusión")) %>%
    kable_styling(full_width = F,
                  bootstrap_options = "striped", "bordered", "condensed",
                  position = "center",
...
summary_aov <- summary(Datos.aov)
  ...
  # Convertir la tabla en una tabla de kable
  aov_table %>%
    kbl(caption = "Resultados del ANOVA",
          col.names = c("Grados Libertad",
                        "Suma cuadrados",
                        "Media suma cuadrados",
                        "Estadístico F",
...
pares_df %>%
  kbl(caption = "Resultados comparaciones múltiples",
        col.names = c("Grupos",
                      "Diferencia estimada",
                      "Desviación Típica",
                      "Grados de libertad",
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  tablamedias2 %>%
    kbl(caption = "IIG. Medias por astillero.",
      col.names = c("Astillero", "Observaciones", "IIG medio")) %>%
  kable_styling(full_width = F,
                bootstrap_options = "striped", "bordered", "condensed",
                position = "center",
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
    ...
    tablashapiro2 <- normalidad2 %>%
    kbl(caption = "Normalidad del IIG (Shapiro-Wilks).",
          col.names = c("Astillero", "p-valor", "Conclusión")) %>%
    kable_styling(full_width = F,
                  bootstrap_options = "striped", "bordered", "condensed",
                  position = "center",
...
aov_table2 <- as.data.frame(summary_aov2[[1]])
  ...
  aov_table2 %>%
    kbl(caption = "Resultados del ANOVA — IIG (solo ilustrativo)",
          col.names = c("Grados Libertad",
                        "Suma cuadrados",
                        "Media suma cuadrados",
                        "Estadístico F",
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  Datos.kmc.df %>%
    kbl(caption = "Kruskal-Wallis. Múltiples diferencias",
          col.names = c("Diferencias medias",
                        "Diferencias críticas",
                        "Significación")) %>%
    kable_styling(full_width = F,
