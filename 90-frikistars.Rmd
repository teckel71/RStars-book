...
![[Un Universo de ficción... y datos.]{.smallcaps}](figuras/frikistars.jpg){width="100%"}
...
![[Encuentros en la tercera... frase.]{.smallcaps}](figuras/encuentro.jpg){width="100%"}
...
Es también el tiempo de los analistas. Junto a los informes oficiales de la AITM, la opinión del sector la marcan cada vez más las consultoras privadas, y ninguna tanto como *Data-Evidence*, con sede en Tatooine. Fundada en 2141 por antiguos estadísticos de la AITM, dio el salto en 2148, cuando la veterana analista y divulgadora **Li Ti-Oh** —dos décadas en los medios especializados del sector— aceptó su dirección ejecutiva. Su informe sectorial de 2150 y los estudios que la consultora ha elaborado para *Dixitaliza*, la AGTI y la ASTI protagonizan varios de los capítulos de este libro.
...
![[Galaxias y planetas de R-Stars.]{.smallcaps}](figuras/mapa_galactico_final.jpg){width="100%"}
...
![[Arrakis, la fuente de la *Especia.*]{.smallcaps}](figuras/Arrakis.png){width="100%"}

![[Pandora, un mundo exuberante de ecosistema protegido.]{.smallcaps}](figuras/Pandora.png){width="100%"}

![[Tatooine, un mundo desértico bajo dos soles.]{.smallcaps}](figuras/Tatooine.png){width="100%"}
...
![[Coruscant, cuna de los astilleros orbitales de *Selene Dynamics*.]{.smallcaps}](figuras/Coruscant.jpg){width="100%"}
...
![[Mustafar, un mundo inestable... en todos los sentidos.]{.smallcaps}](figuras/Mustafar.jpg){width="100%"}
...
![[Fhloston Paradise, un mundo maravilloso y acuático.]{.smallcaps}](figuras/Fhloston%20Paradise.jpg){width="100%"}
...
![[Caprica, un planeta muy parecido a la Tierra]{.smallcaps}](figuras/Caprica.jpg){width="100%"}
...
![[Dr. Sagan Olbers, fundador de la Base de Datos Interestelar.]{.smallcaps}](figuras/Sagan_Olbers_data_scientist.jpg){width="100%"}

-   **Li Ti-Oh.** Experta en transporte interestelar, radicada en Tatooine (Andrómeda), y actual **directora ejecutiva y socia principal de la consultora *Data-Evidence***. Antes pasó casi dos décadas en los medios especializados del sector: redactora de datos en la *Crónica de Fletes de Andrómeda*, directora del *Anuario del Transporte Interestelar* y presentadora en la HoloNet de *Carga Útil*, un programa de análisis económico con fama de desmontar cualquier nota de prensa corporativa con un único gráfico. Desde 2148 dirige *Data-Evidence*; su informe sectorial de 2150 sobre orígenes, fortalezas y debilidades del comercio logístico es de lectura obligada en las escuelas de negocio del sector. Su lema: *"Enséñame la distribución, no la media"*.

![[Li Ti-Oh, directora ejecutiva de Data-Evidence.]{.smallcaps}](figuras/Li%20Ti-Oh_primer_plano.jpg){width="100%"}
...
![[Dra. Xelia Bluebird, AITM.]{.smallcaps}](figuras/Bluebird_primer_plano.jpg){width="100%"}
...
![[Dr. Oren Crestfall, AITM.]{.smallcaps}](figuras/Oren_primer_plano.jpg){width="100%"}
...
![[Mara Qyà, Directora de la ARTI.]{.smallcaps}](figuras/Mara_primer_plano.jpg){width="100%"}
...
![[Romulus Steiner, CEO de Arrakis Freight.]{.smallcaps}](figuras/Romulus%20Steiner_Primer_Plano.jpg){width="100%"}
...
![[Tasha Tachybaptus, CEO de Shuttlepod Movers.]{.smallcaps}](figuras/Tasha_primer_plano.jpg){width="100%"}
...
![[Arg-us Korp, magnate del sector.]{.smallcaps}](figuras/Arg-us%20Korp_primer_plano.jpg){width="100%"}
...
Órgano de representación empresarial del sector. Encarga estudios de percepción y satisfacción de clientes —como el realizado por la consultora [*Data-Evidence*](#c90-data-evidence)— y actúa como interlocutor colectivo del sector ante la AITM y los reguladores. Su sede se sitúa en **Tatooine** (Andrómeda), el planeta con más compañías del sector, en un campus modernista al borde de un oasis cultivado.

### Data-Evidence. {#c90-data-evidence .unnumbered}

Consultora independiente especializada en **análisis de datos y econometría aplicada** al transporte interestelar. Fundada en 2141 en Tatooine por antiguos estadísticos de la AITM, despegó en 2148, cuando **Li Ti-Oh** asumió su dirección ejecutiva. Su lema: *"Primero los datos; después, las opiniones."* Trabaja tanto para compañías privadas como para organismos del sector —lo que la obliga a un estricto protocolo de independencia, revisado cada año por la ARTI—, y sus estudios protagonizan tres capítulos de este libro: el modelo de regresión sobre la renovación de flotas encargado por *Dixitaliza* (capítulo 9), el modelo logit sobre las licencias de la ruta Coruscant–Arrakis (capítulo 10) y el mapa perceptual del sector elaborado para la ASTI (capítulo 12). Su sede ocupa una antigua granja de humedad restaurada a pocos kilómetros del oasis de la ASTI.
...
-   **Data-Evidence.** Consultora de análisis de datos y econometría aplicada con sede en Tatooine, dirigida por Li Ti-Oh. Autora de los estudios de los capítulos 9, 10 y 12 de este libro.
...
El Universo *R-Stars* se extiende más allá de este apéndice y este manual. Existe un libro -narrativo- dedicado a él. Si te pica la curiosidad, sumérgete en él: <https://teckel71.github.io/RStarsUniverso-book/> Incluso tienes un canal de Youtube: <https://youtube.com/playlist?list=PLNUC4VF1PQlY&si=dxGpLycRByThNIkv>
